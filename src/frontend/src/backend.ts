...
import type { Booking as _Booking, BookingStatus as _BookingStatus, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createBooking(arg0: string, arg1: bigint): Promise<{
        __kind__: "ok";
        ok: Booking;
    } | {
        __kind__: "err";
    ...
    async getAvailableSlots(arg0: string): Promise<Array<bigint>> {
        if (this.processError) {
            try {
    ...
    async getBookings(arg0: string, arg1: string): Promise<Array<Booking>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBookings(arg0, arg1);
...
function from_candid_variant_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "active" in value ? BookingStatus.active : "cancelled" in value ? BookingStatus.cancelled : value;
}
